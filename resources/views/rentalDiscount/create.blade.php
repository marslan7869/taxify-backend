...
$(document).ready(function () {
  ...
  $(".save-form-btn").click(function () {
    ...
    database.collection('rental_coupons').where('code', '==', code).get().then(async function (snapshot) {
          ...
          if (code == '') {
              ...
              storeImageData().then(IMG => {
                  ...
                  database.collection('rental_coupons').doc(id).set({ 'code': code, 'description': description, 'discount': discount, 'expiresAt': expiresAt, 'isEnabled': isEnabled, 'id': id, 'discountType': discountType, 'image': IMG }).then(function (result) {
...
function handleFileSelect(evt) {
      ...
      reader.onload = (function (theFile) {
          ...
          return function (e) {
              ...
              fileName = filename;
              photo = filePayload;
              $(".rentaldiscount_image").empty();
              $(".rentaldiscount_image").html('<img class="rounded" style="50px" src="' + photo + '" alt="image">');
          };
      })(f);
