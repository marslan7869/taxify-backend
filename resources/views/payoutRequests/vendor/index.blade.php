            ...
            <div class="col-12">
                <div class="d-flex top-title-section pb-4 justify-content-between">
                    <div class="d-flex top-title-left align-self-center">
                        ...
                        <h3 class="mb-0">{{trans('lang.vendor_payout_request')}}</h3>
...
<script type="text/javascript">
    ...
    columnDefs: [
        ...
        {orderable: false, targets:(id === "" ? [0, 6,7] : [0, 5,6])},
    ...
    async function buildHTML(val) {
            ...
            if (id == "") {
                ...
                var route_url = '{{route("vendors.view",":id")}}';
            ...
            actionHtml = actionHtml + '<span class="action-btn"><a id="' + val.recid + '" class="delete-btn" name="vendor_payouts-delete" href="javascript:void(0)"><i class="mdi mdi-delete"></i></a></span>';
