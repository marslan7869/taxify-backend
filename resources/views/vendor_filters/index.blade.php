                        ...
                        <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                            <li class="nav-item">
                                <a class="nav-link active" href="{!! url()->current() !!}"><i
                                        class="fa fa-list mr-2"></i>{{trans('lang.vendor_filter_table')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('vendorFilters.create') !!}"><i
                                        class="fa fa-plus mr-2"></i>{{trans('lang.vendor_filter_create')}}</a>
                            </li>
