    ...
    $(document).ready(function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            if (data.image == '' || data.image == null) {
                ...
                $(".user_image").append('<span class="image-item"><span class="remove-btn"><i class="fa fa-remove"></i></span><img class="rounded" style="width:50px" src="' + data.image + '"  onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" alt="image">');
