                                   ...
                                   <div class="col-12">
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="section-service-save"
                                                        ...
                                                        {{in_array('section.service.save',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="section-service-edit"
                                                        ...
                                                        name="section-service[]" class="permission"
                                                        {{in_array('section.service.edit',$permissions) ? "checked" : "" }} >
                                                 <label class=" contol-label2"
                                                 ...
                                                 <input type="checkbox" id="section-service-delete"
                                                        ...
                                                        name="section-service[]" class="permission"
                                                        {{in_array('section.service.delete',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="vendors-create" value="vendors.create"
                                                        name="vendors[]" class="permission"
                                                        {{ in_array('vendors.create', $permissions) ? 'checked' : '' }}>
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="vendors-edit" value="vendors.edit" name="vendors[]" class="permission" 
                                                        {{ in_array('vendors.edit', $permissions) ? 'checked' : '' }}>
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="stores-list" value="stores"
                                                        ...
                                                        {{in_array('stores',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="stores-edit"
                                                        ...
                                                        class="permission"
                                                        {{in_array('stores.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="stores-view"
                                                        ...
                                                        class="permission"
                                                        {{in_array('stores.view',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="stores-copy"
                                                        ...
                                                        class="permission"
                                                        {{in_array('stores.copy',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="destinations-list" value="destinations"
                                                        ...
                                                        {{in_array('destinations',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="destinations-edit" value="destinations.edit"
                                                        name="destinations[]" class="permission"
                                                        {{in_array('destinations.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="item-attributes-list" value="item.attributes"
                                                        ...
                                                        {{in_array('item.attributes',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="item-attributes-edit"
                                                        ...
                                                        name="item-attributes[]" class="permission"
                                                        {{in_array('item.attributes.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="review-attributes-list"
                                                        ...
                                                        {{in_array('review.attributes',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="review-attributes-edit"
                                                        ...
                                                        name="review-attributes[]" class="permission"
                                                        {{in_array('review.attributes.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="report-sales"
                                                        ...
                                                        {{in_array('sales',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="subscription-plans-list" value="subscription-plans" name="subscription-plans[]"
                                                            class="permission" {{ in_array('subscription-plans', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="subscription-plans-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="subscription-plans-create" value="subscription-plans.create" name="subscription-plans[]"
                                                            class="permission" {{ in_array('subscription-plans.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="subscription-plans-create">{{ trans('lang.create') }}</label>
                                                        <input type="checkbox" id="subscription-plans-edit" value="subscription-plans.edit" name="subscription-plans[]"
                                                            class="permission" {{ in_array('subscription-plans.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="subscription-plans-edit">{{ trans('lang.edit') }}</label>
                                                        <input type="checkbox" id="subscription-plans-delete" value="subscription-plans.delete" name="subscription-plans[]"
                                                            class="permission" {{ in_array('subscription-plans.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="subscription.history" value="subscription.history" name="subscription-history[]"
                                                            class="permission"  {{ in_array('subscription.history', $permissions) ? 'checked' : '' }}>
                                                 ...
                                                 <td>
                                                        <input type="checkbox" id="ondemand-categories-list"
                                                               ...
                                                               {{in_array('ondemand.categories',$permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-categories-create"
                                                               ...
                                                               class="permission"
                                                               {{in_array('ondemand.categories.create',$permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-categories-edit"
                                                               ...
                                                               name="ondemand-categories[]" class="permission"
                                                               {{in_array('ondemand.categories.edit',$permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-categories-delete"
                                                               ...
                                                               name="ondemand-categories[]" class="permission"
                                                               {{in_array('ondemand.categories.delete',$permissions) ? "checked" : "" }} >
                                                 ...
                                                 <tr>
                                                        ...
                                                        <input type="checkbox" id="ondemand-coupons-list"
                                                               ...
                                                               {{in_array('ondemand.coupons',$permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-coupons-create"
                                                               ...
                                                               class="permission"
                                                               {{in_array('ondemand.coupons.create',$permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-coupons-edit"
                                                               ...
                                                               name="ondemand-coupons[]" class="permission"
                                                               {{in_array('ondemand.coupons.edit',$permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-coupons-delete"
                                                               ...
                                                               name="ondemand-coupons[]" class="permission"
                                                               {{in_array('ondemand.coupons.delete',$permissions) ? "checked" : "" }} >
                                                 ...
                                                 <input type="checkbox" id="ondemand-services-list"
                                                               ...
                                                               {{in_array('ondemand.services.index',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-services-create"
                                                               ...
                                                               class="permission"
                                                               {{in_array('ondemand.services.create', $permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-services-edit"
                                                               ...
                                                               name="ondemand-services[]" class="permission"
                                                               {{in_array('ondemand.services.edit', $permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-services-delete"
                                                               ...
                                                               name="ondemand-services[]" class="permission"
                                                               {{in_array('ondemand.services.delete',$permissions) ? "checked" : "" }} >
                                                 ...
                                                 <tr>
                                                        ...
                                                        <input type="checkbox" id="ondemand-bookings-list"
                                                               ...
                                                               {{in_array('ondemand.bookings.index',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-bookings-print"
                                                               ...
                                                               name="ondemand-bookings[]" class="permission"
                                                               {{in_array('ondemand.bookings.print',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-bookings-edit"
                                                               ...
                                                               name="ondemand-bookings[]" class="permission"
                                                               {{in_array('ondemand.bookings.edit',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-bookings-delete"
                                                               ...
                                                               name="ondemand-bookings[]" class="permission"
                                                               {{in_array('ondemand.bookings.delete',$permissions) ? "checked" : "" }} >
                                                 ...
                                                 <tr>
                                                        ...
                                                        <input type="checkbox" id="ondemand-workers-list"
                                                               ...
                                                               {{in_array('ondemand.workers.index',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-workers-create"
                                                               ...
                                                               name="ondemand-workers[]" class="permission"
                                                               {{in_array('ondemand.workers.create',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-workers-edit"
                                                               ...
                                                               name="ondemand-workers[]" class="permission"
                                                               {{in_array('ondemand.workers.edit',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-workers-delete"
                                                               ...
                                                               name="ondemand-workers[]" class="permission"
                                                               {{in_array('ondemand.workers.delete',$permissions) ? "checked" : "" }} >
                                                        ...
                                                        <input type="checkbox" id="ondemand-onboard-list"
                                                               ...
                                                               {{in_array('onboard.list',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                                        ...
                                                        <input type="checkbox" id="ondemand-onboard-edit"
                                                               value="onboard.edit"
                                                               name="on-board[]" class="permission"
                                                               {{in_array('onboard.edit',$permissions) ? "checked" : "" }} >
                                                        <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="parcel-categories-list"
                                                        ...
                                                        {{in_array('parcel.categories',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="parcel-categories-edit"
                                                        ...
                                                        name="parcel-categories[]" class="permission"
                                                        {{in_array('parcel.categories.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="parcel-weight-list"
                                                        ...
                                                        {{in_array('parcel.weight',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="parcel-weight-edit"
                                                        ...
                                                        name="parcel-weight[]" class="permission"
                                                        {{in_array('parcel.weight.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="parcel-coupons-create"
                                                        ...
                                                        {{in_array('parcel.coupons.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="parcel-coupons-edit"
                                                        ...
                                                        name="parcel-coupons[]" class="permission"
                                                        {{in_array('parcel.coupons.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="parcel-orders-list" value="parcel.orders"
                                                        ...
                                                        {{in_array('parcel.orders',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="parcel-orders-edit"
                                                        ...
                                                        name="parcel-orders[]" class="permission"
                                                        {{in_array('parcel.orders.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="rides-list" value="rides"
                                                        ...
                                                        {{in_array('rides',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="rides-edit" value="rides.edit"
                                                        name="rides[]" class="permission"
                                                        {{in_array('rides.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="cab-promo-create"
                                                        ...
                                                        {{in_array('cab.promo.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="cab-promo-edit"
                                                        ...
                                                        name="cab-promo[]" class="permission"
                                                        {{in_array('cab.promo.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="complaints-edit" value="complaints.edit"
                                                        name="complaints[]" class="permission"
                                                        {{in_array('complaints.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="cab-vehicle-type-create"
                                                        ...
                                                        {{in_array('cab-vehicle-type.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="cab-vehicle-type-edit"
                                                        ...
                                                        name="cab-vehicle-type[]" class="permission"
                                                        {{in_array('cab-vehicle-type.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="rental-vehicle-type-create"
                                                        ...
                                                        {{in_array('rental-vehicle-type.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="rental-vehicle-type-edit"
                                                        ...
                                                        name="rental-vehicle-type[]" class="permission"
                                                        {{in_array('rental-vehicle-type.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="rental-discount-create"
                                                        ...
                                                        {{in_array('rental-discount.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="rental-discount-edit"
                                                        ...
                                                        name="rental-discount[]" class="permission"
                                                        {{in_array('rental-discount.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="rental-orders-list" value="rental-orders"
                                                        ...
                                                        {{in_array('rental-orders',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="rental-orders-edit"
                                                        ...
                                                        name="rental-orders[]" class="permission"
                                                        {{in_array('rental-orders.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="rental-vehicle-list" value="rental-vehicle"
                                                        ...
                                                        {{in_array('rental-vehicle',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="rental-vehicle-view"
                                                        ...
                                                        name="rental-vehicle[]" class="permission"
                                                        {{in_array('rental-vehicle.view',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="make-create"
                                                        ...
                                                        {{in_array('make.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="make-edit"
                                                        value="make.edit"
                                                        name="make[]" class="permission"
                                                        {{in_array('make.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="model-create"
                                                        ...
                                                        {{in_array('model.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="model-edit"
                                                        value="model.edit"
                                                        name="model[]" class="permission"
                                                        {{in_array('model.edit',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="stores-payment" value="stores.payment"
                                                        ...
                                                        {{in_array('stores.payment',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="stores-payout" value="stores.payout"
                                                        ...
                                                        {{in_array('stores.payout',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="drivers-payment" value="drivers.payment"
                                                        ...
                                                        {{in_array('drivers.payment',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="drivers-payout" value="drivers.payout"
                                                        ...
                                                        {{in_array('drivers.payout',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="provider-payment" value="provider.payment"
                                                        ...
                                                        {{in_array('provider.payment',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="provider-payout" value="provider.payout"
                                                        ...
                                                        {{in_array('provider.payout',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                                 ...
                                                 <input type="checkbox" id="payout-request-vendor"
                                                        ...
                                                        {{in_array('payout-request.vendor',$permissions) ? "checked" : "" }} >
                                                 ...
                                                 <input type="checkbox" id="payout-request-driver"
                                                        ...
                                                        {{in_array('payout-request.driver',$permissions) ? "checked" : "" }} >
                                                 ...
                                                 <input type="checkbox" id="payout-request-provider"
                                                        ...
                                                        {{in_array('payout-request.provider',$permissions) ? "checked" : "" }} >
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="stores-payout-create"
                                                        ...
                                                        name="stores-payout[]" class="permission"
                                                        {{in_array('stores.payout.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="drivers-payout-create"
                                                        ...
                                                        name="drivers-payout[]" class="permission"
                                                        {{in_array('drivers.payout.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="provider-payout-create"
                                                        ...
                                                        name="provider-payout[]" class="permission"
                                                        {{in_array('provider.payout.create',$permissions) ? "checked" : "" }} >
                                                 <label class="contol-label2"
                                          ...
                                          <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="business-model"
                                                            ...
                                                            name="business-model[]" class="permission" {{in_array('business-model',$permissions) ? "checked" : ""
                                                        }}>
                                                        <label class=" control-label2"
                                          ...
                                          <tr>
                                                 ...
                                                 <input type="checkbox" id="app-banners-setting"
                                                        ...
                                                        class="permission"
                                                        {{in_array('settings.app.banners',$permissions) ? "checked" : ""
                                                        }} >
                                                 <label class="contol-label2"
